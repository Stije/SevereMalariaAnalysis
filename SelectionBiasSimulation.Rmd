...
plot(TrueOR_anaemia, ORanaemia, 
     xlab = 'Simulated OR for SMA in G6PDd',
     type='l', lwd=3, col =bluecols[3], 
     ylab='Observed OR for SMA in G6PDd', 
...
plot(TrueOR_anaemia, ORcoma,lwd=3, col =redcols[3],
     xlab = 'Simulated OR for SMA in G6PDd',
     type='l', 
     ylab='Observed OR for CM in G6PDd', 
     ylim = range(c(ORcoma,ORanaemia)), yaxt='n')
axis(2, at = c(0.7, 1, 1.8))
...
abline(v = xs, lty=3, lwd=2)
legend('topright', col=c(redcols[3],bluecols[3]), 
       legend = c('Cerebral malaria (CM)','Severe malarial\nanaemia (SMA)'),
       lwd=3, lty=1, cex=.8)
```
