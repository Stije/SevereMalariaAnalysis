...
par(las=1, bty='n')
plot(NA,NA, xlim=c(4,45), ylim=c(0,50),ylab='% predicted mortality', xlab='Haematocrit (%)')
title('Counterfactual predictions of mortality')
for(HCT in 4:45){
  mydata = Leg_data
  mydata$HCT=HCT
...
abline(h=overall_mortality, lwd=3, col='blue',lty=3)
legend('topleft', col=c('black','red','blue'), lwd=3, lty=c(NA,3,3),pch = c(18,NA,NA),
