...
mod_HCT_BD = lmer(formula = BD ~ HCT + (1 | studyID), data = Complete_Leg_data)
summary(mod_HCT_BD)
...
mod_HCT_LPAR = lmer(formula = LPAR_pct ~ HCT + (1 | studyID), data = Complete_Leg_data)
...
mod_BUN_BD = lmer(formula = BD ~ log10(BUN) + (1 | studyID), data = Complete_Leg_data)
summary(mod_BUN_BD)
...
mod_Age_HCT = lmer(formula = HCT ~ AgeInYear + (1 | studyID), data = Complete_Leg_data)
summary(mod_Age_HCT)
