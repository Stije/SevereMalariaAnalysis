...
mtext(text = 'Base deficit (mEq/L)',side = 1,line = 2.5, cex=.9)
...
mtext(text = 'Haematocrit (%)',side = 1,line = 2.5,cex=.9)
...
mtext(text = 'Blood urea nitrogen (mmol/L)',side = 1,line = 2.5,cex=.9)
